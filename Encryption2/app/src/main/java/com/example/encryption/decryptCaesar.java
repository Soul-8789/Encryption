...
public class decryptCaesar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decrypt_caesar);
...
//      decrypt = findViewById(R.id.decrypt_button);
    ...
    public void decodeCaesar(View view){
        String message = input.getText().toString();
        Timestamp timestamp = new Timestamp(System.currentTimeMillis());
        String encrypt_message = caesarDecrypt.decode(message,3);
    ...
    public void copyMessage6(View view){
